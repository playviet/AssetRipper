...
public static partial class SsaSimplifier
{
    ...
    public static void Run(ISILControlFlowGraph cfg, List<LocalVariable> parameterLocals)
    {
        ...
        // A phi handed the same value along every path is that value, and written as a copy of it becomes
        // one more entry here. Judged on what the copies above come to, since a phi is usually handed one
        // copy of the value per path rather than the value itself.
        CollapseTrivialPhis(cfg, parameterLocals, forwarded);
