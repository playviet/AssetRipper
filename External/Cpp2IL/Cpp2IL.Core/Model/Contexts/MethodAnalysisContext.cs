...
public class MethodAnalysisContext : HasGenericParameters, IMethodInfoProvider
{
    ...
    public void Analyze()
    {
        ...
        ForkPipeline.AfterStackAnalysis(this);
        ...
        ForkPipeline.AfterTypesAndFieldsResolved(this);

        // Needs type resolved for delegate locals
        DelegateInvokeRecovery.Run(this);

        ForkPipeline.AfterDelegateInvokeRecovery(this);
        ...
        ForkPipeline.AfterUnusedLocalsAreDropped(this);
    }
